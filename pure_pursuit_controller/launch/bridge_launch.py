...
def generate_launch_description():
    ...
    bridge_11 = Node(
        ...
        arguments=[os.path.join(pkg_dir, 'config', '1_to_2_bridge.yaml')]
    )
    ...
    bridge_22 = Node(
        ...
        arguments=[os.path.join(pkg_dir, 'config', '2_to_1_bridge.yaml')]
    )
    ...
    bridge_33 = Node(
        ...
        arguments=[os.path.join(pkg_dir, 'config', '3bridge.yaml')]
    )
    ...
    bridge_44 = Node(
        ...
        arguments=[os.path.join(pkg_dir, 'config', '4bridge.yaml')]
    )
