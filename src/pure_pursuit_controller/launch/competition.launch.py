...
def generate_launch_description():
    ...
    ld = LaunchDescription([
        ...
        DeclareLaunchArgument('lateral_kp', default_value='2.5'),
        DeclareLaunchArgument('lateral_kd', default_value='0.4'),
    ])
    ...
    # hv_bridge_cfg = PathJoinSubstitution([
    #     pkg_share, 'config',
    #     PythonExpression(["'quiz3bridge.yaml'"])
    # ])

    # ld.add_action(Node( # 한 번만 실행
    #         package='domain_bridge',
    #         executable='domain_bridge',
    #         name=f"hv_19_20_bridge",
    #         output='screen',
    #         arguments=[hv_bridge_cfg],
